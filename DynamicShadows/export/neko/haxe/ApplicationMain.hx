...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("DynamicShadows", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("DynamicShadows", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "DynamicShadows";
		app.meta["name"] = "DynamicShadows";
		...
		#elseif air
		app.window.title = "DynamicShadows";
		#else
